...
const Navbar = ()=>{
    ...
    const handleLogoClick = ()=>{
        router.push('/'); // Refresh the page or navigate to the home page
    };
    const handleNavigate = (path)=>{
        router.push(path); // Navigate to the given path
    };
    const handleAccountClick = ()=>{
        console.log("Account button clicked"); // Placeholder for account actions
        router.push('/account');
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
        className: "flex items-center justify-between bg-blue-600 px-6 py-3 h-16",
        children: [
...
"[project]/src/components/registration.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__0ef64c._.js.map